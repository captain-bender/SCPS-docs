# SCPS Module Documentation

This repository contains documentation and notes for the SCPS project.
...
- [mosquitto_encrypted_passwords.md](mosquitto_encrypted_passwords.md) - How to encrypt the password for mosquitto broker

How to use

- Open these Markdown files in any editor (recommended: VS Code) or online from GitHub